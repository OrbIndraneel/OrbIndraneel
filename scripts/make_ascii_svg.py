...
SHARPEN = False
WHITE_FLOOR = 0.62    # luminance above this is forced to blank (space)
...
USER_HANDLE = os.environ.get("GH_PROFILE_USER", "OrbIndraneel")
FULL_NAME = os.environ.get("PROFILE_FULL_NAME", "Indraneel")
